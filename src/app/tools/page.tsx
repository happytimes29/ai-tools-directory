...
const allTools = [
  ...
  { name: "豆包", url: "https://www.douyin.com", description: "字節跳動旗下 AI 智能助手", category: "llm-chat", pricing: "Free" },
  { name: "Perplexity", url: "https://www.perplexity.ai", description: "AI 搜尋引擎", category: "search", pricing: "Freemium" },
  { name: "秘塔AI搜索", url: "https://metaso.cn", description: "秘塔科技 AI 搜索", category: "search", pricing: "Free" },
  { name: "Genspark", url: "https://genspark.com", description: "AI 搜尋與智能代理", category: "search", pricing: "Freemium" },
  { name: "Devv AI", url: "https://devv.ai", description: "開發者 AI 搜尋引擎", category: "coding", pricing: "Freemium" },
  { name: "ChandlerAi", url: "https://chandler.ai", description: "AI 聊天機器人", category: "llm-chat", pricing: "Freemium" },
  { name: "Deepbricks", url: "https://deepbricks.ai", description: "AI 圖片生成", category: "image-generation", pricing: "Freemium" },
  ...
  { name: "Recraft", url: "https://recraft.ai", description: "AI 圖片與設計生成", category: "image-generation", pricing: "Freemium" },
  { name: "StockCake", url: "https://stockcake.com", description: "免費正版高清圖片素材庫", category: "image-generation", pricing: "Free" },
  ...
  { name: "Luma AI", url: "https://lumalabs.ai", description: "AI 3D and video", category: "video-generation", pricing: "Freemium" },
  ...
  { name: "騰訊智影", url: "https://zenvideo.qq.com", description: "騰訊 AI 影片工具", category: "video-generation", pricing: "Freemium" },
  ...
  { name: "BibiGPT", url: "https://bibigpt.co", description: "音視頻 AI 一鍵總結", category: "ai-writing", pricing: "Freemium" },
  ...
  { name: "UseChatGPT.AI", url: "https://usechatgpt.ai", description: "瀏覽器插件到處使用 ChatGPT", category: "coding", pricing: "Freemium" },
  ...
  { name: "AI工具集", url: "https://ai-bot.cn", description: "1000+ AI工具集合", category: "search", pricing: "Free" },
